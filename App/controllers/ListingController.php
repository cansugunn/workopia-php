...
class ListingController
{
    ...
    public function store()
    {
        ...
        if (!empty($errors)) {
            ...
            //             $this->db->query('INSERT INTO listings (title, description, 
            // salary, company, address, city, state, phone, email, 
    ...
    public function destroy($params)
    {
        ...
        $listing = $this->db->query('DELETE  FROM listings WHERE id=:id', $params)->fetch();
    ...
    public function update($params)
    {
        ...
        if (!empty($errors)) {
            ...
            $_SESSION['sucess_message'] = 'Listing updated';
